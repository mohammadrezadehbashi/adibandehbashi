...
namespace OurCms.Areas.Admin.Controllers
{
    ...
    public class PagesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PageID,GroupID,Title,ShortDescription,Text,Visit,ShowInSlider,ImageName,CreateDate,Tags")] Page page,HttpPostedFileBase imgUp)
        {
            ...
            ViewBag.GroupID = new SelectList(pageGroupRepository.GetAllPageGroup(), "GroupID", "GroupTitle", page.GroupID);
            return View(page);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PageID,GroupID,Title,ShortDescription,Text,Visit,ShowInSlider,ImageName,CreateDate,Tags")] Page page,HttpPostedFileBase imgUp)
        {
            if (ModelState.IsValid)
            {
                if(imgUp != null)
